      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            I enjoy taking on tough challenges, whether it’s building AI models 
            to speed up simulations or creating tools that make data easier to 
            understand. I’m especially curious about how AI can be used in 
